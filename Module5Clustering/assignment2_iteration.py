...
list_in_numbers = df['In'].unique().tolist()
#print list_in_numbers
...
for i in list_in_numbers:
    user1 = df.loc[df['In'] == i]
    ...
    ax.scatter(user1.TowerLon,y=user1.TowerLat, c='g', marker='o', alpha=0.2)
    ...
    kmeans_model.fit(user1[['TowerLat', 'TowerLon']])
