...
y = pd.read_csv('Datasets/face_labels.csv', header= None, names= ['label'])['label']
...
data_train, data_test, label_train, label_test = train_test_split(X, y, test_size=0.15, random_state=7)
...
print n, model.score(data_test, label_test)
