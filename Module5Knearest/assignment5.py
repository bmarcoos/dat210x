...
feature_mean = X.mean()
X.fillna(feature_mean, inplace=True)
#print X
...
X_train, X_test, label_train, label_test = train_test_split(T, y, test_size=0.33, random_state=1)
...
print n, knn.score(X_test, label_test)
