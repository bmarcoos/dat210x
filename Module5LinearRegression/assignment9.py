...
X_train, X_test, y_train, y_test = train_test_split(X[['Room.Board']], X[['Accept']], test_size=0.30, random_state=7)
...
X_train, X_test, y_train, y_test = train_test_split(X[['Enroll']], X[['Accept']], test_size=0.30, random_state=7)
model.fit(X_train, y_train)
score = model.score(X_test, y_test)
...
X_train, X_test, y_train, y_test = train_test_split(X[['F.Undergrad']], X[['Accept']], test_size=0.30, random_state=7)
model.fit(X_train, y_train)
score = model.score(X_test, y_test)
...
X_train, X_test, y_train, y_test = train_test_split(X[['Room.Board','Enroll']], X[['Accept']], test_size=0.30, random_state=7)
model.fit(X_train, y_train)
score = model.score(X_test, y_test)
