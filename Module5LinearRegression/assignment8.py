...
X_train = X_train[['Year']]#X_train.drop(['WhiteMale'], axis=1)

X_test = X[X['Year'] >= 1986]
y_test = X_test[['WhiteMale']]
X_test = X_test[['Year']]#X_test.drop(['WhiteMale'], axis=1)
...
X_train2 = X[X['Year'] < 1986]
y_train2 = X_train2[['BlackFemale']]
X_train2 = X_train2[['Year']]

X_test2 = X[X['Year'] >= 1986]
y_test2 = X_test2[['BlackFemale']]
X_test2 = X_test2[['Year']]


model2 = linear_model.LinearRegression()
model2.fit(X_train2, y_train2)

drawLine(model2, X_test2, y_test2, "BlackFemale")
