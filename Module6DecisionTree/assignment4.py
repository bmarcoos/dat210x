...
C = 1.0
kernel = 'linear'
iterations = 5000 #5000   # TODO: Change to 200000 once you get to Question#2
...
n = 5
knn = KNeighborsClassifier(n_neighbors = n) # uniform
#model.fit(X_train, label_train)

benchmark(dtree, 'Decision Tree')
drawPlots(dtree, 'Decision Tree')
